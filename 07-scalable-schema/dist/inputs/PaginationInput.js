...
__decorate([
    ...
    (0, class_validator_1.Min)(1, { message: 'Page number must be at least 1' }) // Validate that page must be at least 1
    ,
    __metadata("design:type", Number)
], PaginationInput.prototype, "page", void 0);
__decorate([
    (0, type_graphql_1.Field)(() => type_graphql_1.Int, { defaultValue: 10 }),
    (0, class_validator_1.Min)(1, { message: 'Page size must be at least 1' }) // Validate that page size must be at least 1
    ,
    __metadata("design:type", Number)
