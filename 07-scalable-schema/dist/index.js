...
const QueryResolver_1 = require("./resolvers/QueryResolver");
const MutationResolver_1 = require("./resolvers/MutationResolver");
...
function startServer() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const schema = yield (0, type_graphql_1.buildSchema)({
            resolvers: [QueryResolver_1.QueryResolver, MutationResolver_1.MutationResolver],
        });
